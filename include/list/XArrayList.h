...
{
    // TODO
    if(index >= this->count) throw std::out_of_range("Index out of range");
...
{
    // TODO
    if(this->count == 0 || (index < 0 || index >= this->count -1)) throw std::out_of_range("Index out of range");

...
#include <iostream>
#include <iomanip>
#include "F:\DSA2\dsastudents\dsastudents\include\list\XArrayList.h"
#include "F:\DSA2\dsastudents\dsastudents\include\util\Point.h"
using namespace std;
...
void demoRemoveAt(){
    ...
    list1.add(Point(23.2f, 25.4f));
    list1.add(Point(24.6f, 23.1f));
    list1.add(Point(122.5f, 22.3f));
    list1.add(Point(231.2f, 25.4f));
    list1.add(Point(234.6f, 23.1f));
    list1.add(Point(121.5f, 22.3f));
    list1.removeAt(3);
    list1.println();
}
